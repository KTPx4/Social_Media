...
const EditPostModal: React.FC<EditPostModalProps> = ({ visible, onHide, post, onSave, toast }) => {
    // theme
    ...
    return (
        ...
        >
            ...
            <div>
                <h5>Status</h5>
                <Dropdown style={{maxWidth: 125}}  value={selectStatus} onChange={(e) => setSelectStatus(e.value)} options={listStatus} optionLabel="name"
